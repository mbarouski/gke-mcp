...
func Install(_ context.Context, s *mcp.Server, _ *config.Config) error {
	s.AddPrompt(&mcp.Prompt{
		Name:        "gke:upgradesbestpracticesriskreport",
		Description: "Generate GKE cluster upgrade best practices risk report.",
...
// gkeUpgradesBestPracticesRiskReportHandler is the handler function for the /gke:upgradesbestpracticesriskreport prompt
