...
func Test_extractReleaseNotesRelevantForUpgrade(t *testing.T) {
	fullNotes := `
## 1.35.0-gke.900000
- Notes for 1.35.0, feature A.
- Bug fix B.

## 1.34.0-gke.800000
- Notes for 1.34.0, feature C.
- Security update D.

## 1.33.0-gke.700000
- Notes for 1.33.0, feature E.
- Performance improvement F.

## 1.32.0-gke.600000
- Notes for 1.32.0, feature G.
- Deprecation H.

## 1.31.0-gke.500000
- Notes for 1.31.0, feature I.
- Breaking change J.

## 1.30.0-gke.400000
- Notes for 1.31.0, feature K.
- Breaking change L.

## 1.30.0-gke.300000
- Notes for 1.31.0, feature M.
- Breaking change N.
`

	fullNotes2 := fullNotes
	fullNotes2 = `
November 14, 2025
...
`,
		...
		// 		{
		// 			name: "no exact source and target version but they are in range of versions from release notes",
		// 			args: args{
		// 				fullReleaseNotes: fullNotes2,
		// 				targetVersion:    "1.33.0-gke.600000",
		// 				sourceVersion:    "1.31.1-gke.600000",
		// 			},
		// 			want: `1.33.0-gke.700000
		// - Notes for 1.33.0, feature E.
		// - Performance improvement F.
		...
		// 			args: args{
		// 				fullReleaseNotes: fullNotes2,
		// 				targetVersion:    "1.34.0-gke.800000",
		// 				sourceVersion:    "1.32.0-gke.600000",
		// 			},
		// 			want: `1.34.0-gke.800000
		// - Notes for 1.34.0, feature C.
		// - Security update D.
